...
return [
    'routes' => [
        ...
        // CODE
        ['name' => 'code#getWopi', 'url' => '/code/wopi/{path}', 'verb' => 'GET', 'defaults' => ['path' => ''], 'requirements' => ['path' => '.*']],
        ['name' => 'code#postWopi', 'url' => '/code/wopi/{path}', 'verb' => 'POST', 'defaults' => ['path' => ''], 'requirements' => ['path' => '.*']],
        ['name' => 'code#getStatus', 'url' => '/code/status', 'verb' => 'GET']
    ],
    'ocs' => [
